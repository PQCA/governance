 ...
 *\[Link to signed project charter\]*

 *\[Link to signed contribution agreement\]*
...
- [ ] Draft a [blog post](https://pqca.org/blog/) announcing your project and describe what the project is, why it is being open sourced and how people can get involved.  
- [ ] **Optional:** [Book time with PQCA staff](https://meetings.hubspot.com/christina-harter/pqca-project-onboarding-call) to understand project benefits and event resources or ask other questions.
...
- [ ] **Optional:** Set up [Discord channel(s)](https://discord.com/channels/1202723482224295936/1214569223012089878). Confirm channels needed (announce, project contributors, etc.) and who should have admin privileges.  
- [ ] **Optional:** Set up [public project calls](https://pqca.org/calendar/) . Confirm date/time, meeting cadence and who should have host privileges. 
- [ ] **Optional:** Set up [a mailing list](https://lists.pqca.org/groups) as a way to communicate to your TSC and other project community members.
